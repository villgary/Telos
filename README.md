...
- **AI Agent 云端发现** — 通过 Anthropic Console / OpenAI Dashboard Admin Key 自动发现云端 AI Agent（组织、项目、API Key），支持 6h 定时 + 手动同步。操作详见 [docs/cloud-agent-discovery.md](docs/cloud-agent-discovery.md)
